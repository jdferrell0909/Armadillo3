...
describe('Product Route Integration', () => {
  describe('GET /products', () => {
    ...
    it("returns an Object with the Property 'products'", () => request(server)
      .get('/api/products/1')
      .then((res) => expect(res.body).toHaveProperty('products')));

    it("'products' contains and array that includes and Object containing : _id, user_id, product_id, product_name, image_url and the appropriate data types", () => request(server)
      .get('/api/products/1')
      .then((res) => {
  ...
  describe('DELETE /products', () => {
    ...
    it("returns with the String 'Delete product'", () => request(server)
      .delete('/api/products/1/24')
